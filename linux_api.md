...
Первым таким заголовком является **ELF Header**, *всегда* располагающийся в самом начале образа программы на нулевом смещении. Он предоставляет общее описание исполняемого файла и содержит следующий набор полей:
...
Заголовки *сегментов* ELF-файла располагаются в таблице **ELF Program Header**, каждая запись которой имеет следующую структуру:
