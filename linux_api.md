...
Данный вызов *необходимо* использовать совместно с *предварительной блокировкой* `sigprogmask(set)` интересующих нас сигналов во избежание *состояния гонки (data race)* между поступлением сигнала и его синхронным ожиданием: мы можем не успеть приостановить процесс, и доставка сигнала будет осуществлена согласно его диспозиции.
