...
+ `UMOUNT_NOFOLLOW` - не разыменовывать символические ссылки в аргументе `target`.
...
### 5.3.2. Информация о файловой системе
...
Возвращает информацию о файловой системе по путевому имени или дескриптору расположенного в ней файла.
