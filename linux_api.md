...
+ `RTLD_GLOBAL` - символы из текущей библиотеки и её дерева зависимостей можно использовать для разрешения ссылок в загружаемых впоследствии библиотеках, а также в поиске `dlsym()`;
+ `RTLD_LOCAL` - противоположный по смыслу флаг. Используется по умолчанию, если не задана ни одна константа;
