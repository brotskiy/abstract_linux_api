...
**Виртуальная файловая система proc**, расположенная в одноименном каталоге `/proc`, содержит набор каталогов, предоставляющих статистику о работе системы. Она не хранится на диске, а её файлы и каталоги генерируются ядром на лету при обращении к ним процессов.
