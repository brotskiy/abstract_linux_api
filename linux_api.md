...
### 8.2.4. Динамическая загрузка библиотек dlopen
...
### 8.2.5. Правила именования разделяемых библиотек
...
### 8.2.6. Совместное использование статических и разделяемых библиотек
...
### 8.2.7. Команды оболочки для работы с разделяемыми библиотеками
