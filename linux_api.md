...
Деинициализирует *открытый* мьютекс `mutex` - после этого занимаемую переменной мьютекса память можно освобождать, либо мьютекс можно инициализировать повторно.
...
*Открывает* ранее закрытый *данным потоком* мьютекс - в противном случае возвращает ошибку.
