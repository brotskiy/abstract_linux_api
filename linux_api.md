...
+ разделяемые библиотеки должны компилироваться с поддержкой адресно-независимового кода, использование которого влечет дополнительные издержки при выполнении программ.
...
+ исходные коды разделяемой библиотеки должны компилироваться с флагом `-fPIC` - *адресно-независимый код*, который может быть размещен в любом участке виртуальной памяти процесса;
