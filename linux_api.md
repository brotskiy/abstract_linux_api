...
**Корневой каталог**, являющийся основанием виртуальной файловой системы Linux ВСЕГДА хранится в файле с индексным дескриптором под номером `2`.

Каждый процесс имеет 2 атрибута:

+ **корневой каталог**, относительно которого интерпретируются *абсолютные путевые имена*;
...
**Символическая (мягкая) ссылка** - это отдельный файл специального типа, содержащий путевое имя другого файла (целевой объект), на который данная ссылка указывает.

![символические ссылки](images/img-16.png)

Путевое имя в теле ссылки может быть как абсолютным, так и относительным. Также *символические ссылки* могут указывать на имена, расположенные в *других файловых системах*.
